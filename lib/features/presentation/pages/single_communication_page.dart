...
import 'package:clinic_app/features/presentation/cubit/my_appointment/my_appointment_cubit.dart';
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          else if (message.messsageType == AppConst.odpMessage)
            return _messageLayoutODP(
              isOPD: message.isOdp,
              color: message.isOdp == false
                  ? Colors.lightGreen[400]
                                ...
                                onTap: () {
                                  ...
                                  BlocProvider.of<MyAppointmentCubit>(context)
                                      .deleteMyAppointment(
                                          ...
                                          messageType: AppConst.textMessage, recipientPhoneNumber: '', senderPhoneNumber: '');
                                },
                                child: Container(
                              ...
                              InkWell(
                                onTap: () {
                                  ...
                                  BlocProvider.of<MyAppointmentCubit>(context)
                                    ...
                                    senderId: widget.senderUID,
                                    recipientName: widget.recipientName,
                                    senderName: widget.senderName, message: '', messageType: '', recipientPhoneNumber: '', senderPhoneNumber: '',
                                  );
                                },
                                child: Container(
                                  padding: EdgeInsets.symmetric(
    ...
    Widget okButton = TextButton(
      ...
      onPressed: () {
        ...
        BlocProvider.of<UserCubit>(context).sendTextMessage(
            ...
            senderName: widget.senderName,
            message: _setYourTimeController.text,
            messageType: AppConst.odpMessage, recipientPhoneNumber: '', senderPhoneNumber: '');
