...
import 'package:clinic_app/features/presentation/pages/single_item_appointment_user_page.dart';

class ODPPage extends StatefulWidget {
  final String uid;

  const ODPPage({required Key key, required this.uid}) : super(key: key);
  @override
...
class _ODPPageState extends State<ODPPage> {
  ...
  void initState() {
    BlocProvider.of<MyAppointmentCubit>(context)
        .getAppointments(uid: widget.uid);
    super.initState();
  }
