...
class ProfilePage extends StatefulWidget {
  ...
  const ProfilePage({required Key key,required this.uid}) : super(key: key);
        ...
        body: BlocBuilder<UserCubit,UserState>(
          builder: (_,state){
            if (state is UserLoaded){
              final user=state.data.firstWhere((user) => user.uid==widget.uid,orElse: () => UserModel(accountType: '', email: '', isHide: '', isOnline: false, name: '', profileUrl: '', uid: ''));
