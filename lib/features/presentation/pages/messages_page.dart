...
import 'package:clinic_app/features/presentation/pages/single_item_chat_user_page.dart';

class MessagesPage extends StatefulWidget {
  final String uid;

  const MessagesPage({required Key key,required this.uid}) : super(key: key);
  @override
      ...
      itemBuilder: (_, index) {
        ...
        return InkWell(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(
              builder: (_) => SingleCommunicationPage(
                ...
                recipientName: myChat.recipientName, key: UniqueKey(),
              ),
            ));
          },
          child: SingleItemChatUserPage(
            ...
            time: DateFormat('hh:mm a').format(myChat.time.toDate()), key: UniqueKey(),
          ),
        );
      },
    );
