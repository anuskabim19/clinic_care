...
import 'package:clinic_app/features/presentation/cubit/get_hospital/get_hospital_cubit.dart';
import 'package:clinic_app/features/presentation/cubit/get_hospital_details/get_hospital_details_cubit.dart';
import 'package:clinic_app/features/presentation/cubit/user/user_cubit.dart';
import 'package:clinic_app/features/presentation/pages/single_communication_page.dart';
import 'package:clinic_app/features/presentation/widgets/common.dart';
            ...
            return Stack(
              children: <Widget>[
                  ...
                  child: BlocBuilder<GetHospitalCubit, GetHospitalState>(
                    builder: (context, getHospitalState) {
                      if (getHospitalState is GetHospitalLoaded) {
                        ...
                        //             BlocProvider.of<GetHospitalDetailsCubit>(
                        //                     context)
                        //                 .getHospitalDetails(
                        //                     hospitalId: getHospitalState
                        //                         .hospitalData[index]
                        //                         .hospitalId);
                        //           },
                        //           child: _listItem(
                ...
                Positioned(
                  left: 10,
                  top: 35,
                  child: BlocBuilder<GetHospitalDetailsCubit,
                      GetHospitalDetailsState>(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            "${getHospitalDetailsState.data[index].doctorName}",
                                            maxLines: 1,
                                          ...
                                          Text(
                                            "${getHospitalDetailsState.data[index].qualification}",
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                fontSize: 10,
                                          ...
                                          Text(
                                            getHospitalDetailsState
                                                    ...
                                                    "null"
                                                ? "Email: --"
                                                : "${getHospitalDetailsState.data[index].email}",
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                fontSize: 10,
                                          ...
                                          Text(
                                            "Gender: ${getHospitalDetailsState.data[index].gender}",
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                fontSize: 10,
                                          ...
                                          InkWell(
                                            onTap: () {
                                              if (getHospitalDetailsState
                                                ...
                                                snackBar(
                                                  msg: "Message is disabled",
                                                  scaffoldState: scaffoldState,
                                                  context:
                                                      context, // Pass the valid BuildContext object
                                                );
                                              }
                                            },
                                            child: Container(
      ...
      child: Row(
        children: [
          Container(
            ...
            child: hospitalData[index].hospitalPicUrl.isEmpty
                ? Image.asset(
                    "assets/image.jpeg",
                    fit: BoxFit.cover,
                  )
                : ClipRRect(
                    borderRadius: BorderRadius.all(Radius.circular(8)),
                    child: Image.network(
                      hospitalData[index].hospitalPicUrl,
                      fit: BoxFit.cover,
                    ),
                  ),
          ),
