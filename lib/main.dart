...
import 'package:clinic_app/features/presentation/Screens/Login/login_screen.dart';
import 'package:clinic_app/features/presentation/cubit/communication/communication_cubit.dart';
...
import 'package:clinic_app/features/presentation/cubit/google_auth/google_auth_cubit.dart';
import 'package:clinic_app/features/presentation/cubit/my_chat/my_chat_cubit.dart';
            ...
            return BlocBuilder<AuthCubit, AuthState>(
              builder: (context, authState) {
                if (authState is Authenticated) {
                  return HomeScreen(uid: authState.uid, key: UniqueKey(),);
                } else
                  return LoginScreen();
              },
            );
